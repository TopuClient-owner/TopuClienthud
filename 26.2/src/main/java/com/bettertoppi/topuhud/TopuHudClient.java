...
public final class TopuHudClient implements ClientModInitializer {
    ...
    private static final KeyMapping MENU=KeyMappingHelper.registerKeyMapping(new KeyMapping("key.topuhud.menu",InputConstants.Type.KEYSYM,InputConstants.KEY_RIGHT_SHIFT,CATEGORY));
